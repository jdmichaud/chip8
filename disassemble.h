...
char *disassembler_SYS(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_CLS(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_RET(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_JP(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_CALL(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SE(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SNE(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SE2(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD1(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_ADD(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD2(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_OR(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_AND(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_XOR(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_ADD2(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SUB(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SHR(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SUBN(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SHL(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SNE2(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LDI(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_JP2(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_RND(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_DRW(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SKP(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_SKNP(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD3(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD4(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD5(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD6(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_ADD3(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD7(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD8(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD9(uint8_t lsb, uint8_t msb, char *buffer);
char *disassembler_LD10(uint8_t lsb, uint8_t msb, char *buffer);

typedef char *(*dinstruction_ptr_t)(uint8_t, uint8_t, char*);
typedef struct {
  const char *name;
